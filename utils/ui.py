...
TOOL_BUNDLES: dict[str, tuple[str, ...]] = {
    ...
    "json_formatter": ("base64_tool", "config_format_converter", "json_diff", "xml_formatter", "yaml_formatter", "json_path_query", "json_to_typescript"),
    ...
    "base_converter": ("hash_generator", "id_generator", "byte_size_converter", "number_to_words"),
    ...
    "markdown_toc_generator": ("markdown_converter", "csv_to_markdown"),
    ...
    "jwt_claims_reference": ("jwt_decoder", "jwt_encoder", "jwt_weak_secret"),
}
