...
TOOL_BUNDLES: dict[str, tuple[str, ...]] = {
    ...
    "http_status_reference": ("http_status", "webhook_tester", "exit_code_reference"),
    ...
    "json_formatter": ("base64_tool", "config_format_converter", "json_diff", "xml_formatter", "yaml_formatter", "json_path_query"),
    ...
    "http_header_parser": ("security_headers", "http_status", "basic_auth_tool"),
    ...
    "base58_tool": ("base64_tool", "base32_tools"),
