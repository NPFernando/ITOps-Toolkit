...
TOOL_BUNDLES: dict[str, tuple[str, ...]] = {
    ...
    "config_format_converter": ("json_formatter", "text_diff_checker", "env_linter", "markdown_converter"),
    ...
    "text_diff_checker": ("regex_tester", "case_converter", "csv_diff"),
    ...
    "business_hours": ("timestamp_converter", "uptime_trend", "log_duration"),
