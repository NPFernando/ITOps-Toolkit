...
TOOL_BUNDLES: dict[str, tuple[str, ...]] = {
    ...
    "keypair_generator": ("password_generator", "hash_generator", "csr_decoder"),
    ...
    "base64_tool": ("json_formatter", "url_encoder_decoder", "base32_tools"),
    "url_encoder_decoder": ("base64_tool", "json_formatter", "url_parser"),
    "regex_tester": ("text_diff_checker", "json_formatter", "regex_cheat_sheet"),
    "text_diff_checker": ("regex_tester", "case_converter", "csv_diff", "whitespace_visualizer"),
    ...
    "csv_diff": ("json_diff", "text_diff_checker"),
    "markdown_converter": ("config_format_converter",),
    ...
    "csr_decoder": ("ssl_certificate", "keypair_generator"),
