...
TOOL_BUNDLES: dict[str, tuple[str, ...]] = {
    ...
    "ssl_certificate": ("domain_health", "dns_records", "http_status", "tls_scanner", "csr_decoder", "pem_bundle_splitter"),
    ...
    "security_headers": ("http_status", "ssl_certificate", "robots_validator", "http_header_parser"),
    ...
    "jwt_decoder": ("jwt_encoder", "hash_generator", "jwt_weak_secret"),
    "jwt_encoder": ("jwt_decoder", "hash_generator", "jwt_weak_secret"),
    "json_formatter": ("base64_tool", "config_format_converter", "json_diff", "xml_formatter", "yaml_formatter"),
    ...
    "base_converter": ("hash_generator", "id_generator", "byte_size_converter"),
    "config_format_converter": ("json_formatter", "text_diff_checker", "env_linter", "markdown_converter", "xml_formatter", "yaml_formatter"),
    "base64_tool": ("json_formatter", "url_encoder_decoder", "base32_tools", "html_entity_tools"),
    ...
    "text_diff_checker": ("regex_tester", "case_converter", "csv_diff", "whitespace_visualizer", "text_stats", "line_ending_converter"),
    "case_converter": ("text_diff_checker", "url_encoder_decoder", "text_stats"),
    "color_converter": ("qr_code_generator", "case_converter"),
    "timestamp_converter": ("cron_explainer", "business_hours", "log_duration", "date_calculator", "world_clock"),
    ...
    "markdown_converter": ("config_format_converter", "csv_to_markdown"),
    "encoding_detector": ("file_integrity",),
    "robots_validator": ("security_headers", "http_status"),
    ...
    "http_header_parser": ("security_headers", "http_status"),
    "cidr_overlap": ("cidr_aggregator", "subnet_calculator"),
    "csr_decoder": ("ssl_certificate", "keypair_generator", "ssh_fingerprint"),
    "pem_bundle_splitter": ("ssl_certificate",),
    ...
    "luhn_validator": ("hash_generator",),
    "text_stats": ("text_diff_checker", "case_converter"),
    "csv_to_markdown": ("csv_diff", "markdown_converter", "csv_json_converter", "csv_cleaner"),
    ...
    "password_entropy": ("password_generator",),
    "pattern_extractor": ("regex_tester", "log_troubleshooting"),
    ...
    "world_clock": ("timestamp_converter", "business_hours", "date_calculator"),
    "csv_cleaner": ("csv_diff", "csv_to_markdown", "line_sorter"),
}
