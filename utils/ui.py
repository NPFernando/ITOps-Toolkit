...
TOOL_BUNDLES: dict[str, tuple[str, ...]] = {
    ...
    "json_formatter": ("base64_tool", "config_format_converter", "json_diff", "xml_formatter"),
    ...
    "config_format_converter": ("json_formatter", "text_diff_checker", "env_linter", "markdown_converter", "xml_formatter"),
    ...
    "text_diff_checker": ("regex_tester", "case_converter", "csv_diff", "whitespace_visualizer", "text_stats"),
    "case_converter": ("text_diff_checker", "url_encoder_decoder", "text_stats"),
    "color_converter": ("qr_code_generator", "case_converter"),
    "timestamp_converter": ("cron_explainer", "business_hours", "log_duration", "date_calculator"),
    ...
    "csv_diff": ("json_diff", "text_diff_checker", "csv_to_markdown"),
    ...
    "whitespace_visualizer": ("text_diff_checker",),
    "date_calculator": ("timestamp_converter", "business_hours"),
    "xml_formatter": ("json_formatter", "config_format_converter"),
    ...
    "csv_to_markdown": ("csv_diff", "markdown_converter"),
