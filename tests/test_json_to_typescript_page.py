...
PAGE = str(Path(__file__).resolve().parent.parent / "pages" / "101_JSON_to_TypeScript.py")
...
def test_generate_shows_result():
    ...
    app.text_area[0].set_value('{"name": "Alice"}')
    ...
    assert "TypeScript interfaces ready" in md
...
def test_empty_submission_shows_warning_status():
    ...
    assert "TypeScript generation needs input fixes" in md
