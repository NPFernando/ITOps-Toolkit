...
def test_wave32_home_and_roadmap_keep_explicit_status_semantics():
...
def test_wave32_lorem_and_text_converter_keep_deterministic_outcomes():
    ...
    assert 'role="status"' in _markdown(text_app)
    assert 'aria-live="polite"' in _markdown(text_app)
