...
def test_wave47_pages_keep_shell_and_visual_icon_markers():
...
def test_wave47_mapped_page_headings_keep_scan_friendly_hierarchy():
    expected_snippets = {
        "app.py": (
    ...
    for rel_path, snippets in expected_snippets.items():
        ...
        for snippet in snippets:
            assert snippet in source, f"{rel_path}: missing wave-47 heading hierarchy snippet {snippet!r}"
