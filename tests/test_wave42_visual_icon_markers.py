...
def test_wave42_pages_keep_shell_and_visual_icon_markers():
...
def test_wave42_mapped_page_headings_remain_scan_friendly():
    expected_snippets = {
        "app.py": (
    ...
    for rel_path, snippets in expected_snippets.items():
        ...
        for snippet in snippets:
            assert snippet in source, f"{rel_path}: missing wave-42 heading hierarchy snippet {snippet!r}"
